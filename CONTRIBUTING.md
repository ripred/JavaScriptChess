...
Thanks for helping improve this project. The best contributions are small, testable, and clear about the problem they address.
...
Search existing issues first. Include the project version or commit, platform, tool versions, and the exact command, input, or workflow involved.
